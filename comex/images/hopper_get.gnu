...
set logscale x 2
set key left
#set terminal postscript eps enhanced defaultplex "Helvetica" 28
set term postscript color eps enhanced dashed defaultplex "Helvetica" 28
#set term postscript eps defaultplex "Helvetica" 28

set title "DMAPP (Gemini Cray XE) Get Bandwidth"
set output 'hopper_get.eps'
plot 'hopper_perf_native.txt' index 1 using 1:($3) title "" lw 10
